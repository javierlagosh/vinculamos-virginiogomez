    ...
    success: function (resConsultar) {
      ...
      if (cobertura == null) {
        ...
        if (divisor == null || divisor == 0 || dividendo == 0) {
          ...
          cobertura_puntaje = Math.round((dividendo*0.5 +  ptje_externos*0.5));
      ...
      $("#cobertura-puntaje").text(cobertura_puntaje + "dividendo: " + dividendo + " divisor: " + divisor + " - " + ptje_externos);
