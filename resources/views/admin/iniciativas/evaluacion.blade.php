...
@section('contenido')
        ...
        <div class="section-body">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <a onclick="listarEval({{ $iniciativa[0]->inic_codigo }})" class="btn btn-icon btn-success icon-left"
                        data-toggle="tooltip" data-placement="top" title="Actualizar listado"
                        style="color: rgb(255, 255, 255)"><i class="fas fa-sync-alt"></i>Recargar listado</a>
                </div>
                <div class="card-body">
    ...
    <script>
        ...
        function enviarEval() {
            ...
            var puntaje = $("#puntaje_obtenido").val();
