                                        ...
                                        @foreach ($convenios as $conv)
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{-- <a href="{{ route('admin.previsualizar.convenio', $conv->conv_codigo) }}" class="btn btn-icon btn-info"
                                                        target="_blank" data-toggle="tooltip" data-placement="top" title="Previsualizar">
